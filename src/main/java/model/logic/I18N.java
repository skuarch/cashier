...
public class I18N {
    ...
    static{
        ...
        arrayList.add("text225");
        arrayList.add("text228");
        arrayList.add("text257");
        arrayList.add("text258");
        arrayList.add("text259");
        arrayList.add("text260");
        arrayList.add("text261");
