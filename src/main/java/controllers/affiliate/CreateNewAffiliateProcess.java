...
public class CreateNewAffiliateProcess extends BaseController {
    ...
    public ModelAndView createNewAffiliate(
        ...
        try {
            ...
            //get person from session, this is who created the affliate
            personBasicInformation = PersonBasicInformationUtil.getPersonBasicInformation(session);

            //create parameters
            parameters = ApplicationUtil.createParameters(personName,
                    personLastName,
                    personEmail,
                    personPhone,
                    personPassword,
                    ...
                    clabe,
                    emailNotifications,
                    personBasicInformation.getPersonId()
            );
